...
from .serializers import FlightSerializer, BookingSerializer, BookingDetailsSerializer, UpdateBookingSerializerAdmin, UpdateBookingSerializerNormal, RegisterSerializer
...
class UpdateBooking(RetrieveUpdateAPIView):
	...
	def get_serializer_class(self):
		if self.request.user.is_staff:
			return UpdateBookingSerializerAdmin
		else:
